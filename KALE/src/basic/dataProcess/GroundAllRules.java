...
public class GroundAllRules {
	...
	public static void main(String[] args) throws Exception {
		...
		String fnRelationIDMap = "datasets\\relationid.txt";
		String fnRuleType = "dataset\\rules.rules";
		String fnTrainingTriples = "dataset\\train.txt";
		String fnOutput = "dataset\\groundings.txt";
